...
const Banner = (props) => {
    return (
        <div className="w-full h-full mt-24 overflow-y-auto grid grid-cols-1 md:grid-cols-2">
            <section className="full p-12 h-full flex flex-col space-y-3">
                <h1 className="text-white/75 text-5xl md:text-6xl leading-[50px] md:leading-[100px] font-bold capitalize">Lorem ipsum <br></br> dolor sit amet</h1>
                <br></br><br></br>
                <div className="text-white/75 text-2xl md:text-xl">
            ...
            <div className="w-full h-full flex flex-column space-y-4">
                <svg className="w-96 md:flex hidden transform transition-all animate-spin duration-250 mx-auto col-span-3 h-96 my-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
